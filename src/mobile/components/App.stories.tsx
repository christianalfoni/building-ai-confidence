...
// Author viewing their own draft: the draft badge replaces the old read-time
// chip in the title row.
...
// Editor: back + draft/publish sit at the top, the title is focused on mount.
